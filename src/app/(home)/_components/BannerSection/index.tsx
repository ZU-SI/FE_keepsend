      ...
      {banners.map((banner, idx) => (
        ...
        >
          ...
          <div className="hero-banners__content">
            ...
            <h1 className="hero-banners__title">{banner.title}</h1>
            <p className="hero-banners__description">{banner.description}</p>
            <div className="hero-banners__actions">
              ...
              <button className="hero-banners__button hero-banners__button--outline">
                문의하기
              </button>
            </div>
          </div>
